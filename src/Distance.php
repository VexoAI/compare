...
namespace Vexo\Compare\Distance;
 ...
 */
function additiveSymmetric(array $a, array $b): float
{
    $d = 0;
 ...
 * @param float[] $b Second vector
 */
function avg(array $a, array $b): float
{
    $max = 0;
    $ans = 0;
    $aux = 0;
 ...
 * @param float[] $b Second vector
 */
function bhattacharyya(array $a, array $b): float
{
    $ans = 0;
 ...
 * @param float[] $b Second vector
 */
function canberra(array $a, array $b): float
{
    $ans = 0;
 ...
 * @param float[] $b Second vector
 */
function chebyshev(array $a, array $b): float
{
    $max = 0;
    $aux = 0;
 ...
 * @param float[] $b Second vector
 */
function clark(array $a, array $b): float
{
    $d = 0;
 ...
 * @param float[] $b Second vector
 */
function czekanowski(array $a, array $b): float
{
 ...
 * @param float[] $b Second vector
 */
function dice(array $a, array $b): float
{
    $a2 = 0;
    $b2 = 0;
    $prod2 = 0;
 ...
 * @param float[] $b Second vector
 */
function divergence(array $a, array $b): float
{
    $d = 0;
 ...
 * @param float[] $b Second vector
 */
function fidelity(array $a, array $b): float
{
    $ans = 0;
 ...
 * @param float[] $b Second vector
 */
function gower(array $a, array $b): float
{
    $ans = 0;
 ...
 * @param float[] $b Second vector
 */
function harmonicMean(array $a, array $b): float
{
    $ans = 0;
 ...
 * @param float[] $b Second vector
 */
function hellinger(array $a, array $b): float
{
    $ans = 0;
 ...
 * @param float[] $b Second vector
 */
function innerProduct(array $a, array $b): float
{
    $ans = 0;
 ...
 * @param float[] $b Second vector
 */
function intersection(array $a, array $b): float
{
    $ans = 0;
 ...
 * @param float[] $b Second vector
 */
function jeffreys(array $a, array $b): float
{
    $ans = 0;
 ...
 * @param float[] $b Second vector
 */
function jensenDifference(array $a, array $b): float
{
    $ans = 0;
 ...
 * @param float[] $b Second vector
 */
function jensenShannon(array $a, array $b): float
{
    $p = 0;
    $q = 0;
 ...
 * @param float[] $b Second vector
 */
function kdivergence(array $a, array $b): float
{
    $ans = 0;
 ...
 * @param float[] $b Second vector
 */
function kulczynski(array $a, array $b): float
{
    $up = 0;
    $down = 0;
 ...
 * @param float[] $b Second vector
 */
function kullbackLeibler(array $a, array $b): float
{
    $ans = 0;
 ...
 * @param float[] $b Second vector
 */
function kumarJohnson(array $a, array $b): float
{
    $ans = 0;
 ...
 * @param float[] $b Second vector
 */
function lorentzian(array $a, array $b): float
{
    $ans = 0;
 ...
 * @param float[] $b Second vector
 */
function manhattan(array $a, array $b): float
{
    $d = 0;
 ...
 * @param float[] $b Second vector
 */
function matusita(array $a, array $b): float
{
    $ans = 0;
 ...
 */
function minkowski(array $a, array $b, float $p): float
{
    $d = 0;
 ...
 * @param float[] $b Second vector
 */
function motyka(array $a, array $b): float
{
    $up = 0;
    $down = 0;
 ...
 * @param float[] $b Second vector
 */
function neyman(array $a, array $b): float
{
    $d = 0;
 ...
 * @param float[] $b Second vector
 */
function probabilisticSymmetric(array $a, array $b): float
{
    $d = 0;
 ...
 * @param float[] $b Second vector
 */
function ruzicka(array $a, array $b): float
{
    $up = 0;
    $down = 0;
 ...
 * @param float[] $b Second vector
 */
function soergel(array $a, array $b): float
{
    $up = 0;
    $down = 0;
 ...
 * @param float[] $b Second vector
 */
function sorensen(array $a, array $b): float
{
    $up = 0;
    $down = 0;
 ...
 * @param float[] $b Second vector
 */
function squared(array $a, array $b): float
{
    $d = 0;
 ...
 * @param float[] $b Second vector
 */
function squaredChord(array $a, array $b): float
{
    $ans = 0;
 ...
 * @param float[] $b Second vector
 */
function taneja(array $a, array $b): float
{
    $ans = 0;
 ...
 */
function tanimoto(array $a, array $b, bool $bitvector = false): float
{
    if ($bitvector) {
        return 1 - Similarity\tanimoto($a, $b, $bitvector);
    }
 ...
 * @param float[] $b Second vector
 */
function topsoe(array $a, array $b): float
{
    $ans = 0;
 ...
 * @param float[] $b Second vector
 */
function waveHedges(array $a, array $b): float
{
    $ans = 0;
